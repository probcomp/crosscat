...
setup(
        ...
        packages=packages,
        dependency_links=['https://github.com/mit-probabilistic-computing-project/experiment_runner/tarball/master#egg=experiment_runner-0.1.3'],
        install_requires=['experiment_runner==0.1.3'],
