...
%
function state = MLE_do_analyze(state)

    % **From here to the bottom of the file is pretty much copy-pasted from
    % from runModel_independentPriorRanges.m
    state = drawSample(state, 1);
end
