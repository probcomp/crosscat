...
python ../utils/xnet_utils.py read_and_pickle_table_data
python ../utils/xnet_utils.py write_initialization_files --n_chains $n_chains
...
python ../utils/xnet_utils.py link_initialize_to_analyze --initialize_output_filename myOutputDir/part-00000 --n_steps $n_steps
