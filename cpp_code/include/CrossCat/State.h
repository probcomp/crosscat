...
class State {
 public:
  ...
  // calculators
  /**
   * \return The predictive likelihood of a feature belonging to a particular view
   */
  ...
  /**
   * \return The predictive likelihoods of a feature belonging to each view
   */
  std::vector<double> calc_feature_view_predictive_logps(std::vector<double> col_data, int global_col_idx) const;
  /**
   * \return The predictive likelihood of a row belonging to ???
   */
