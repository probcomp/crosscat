...
cdef extern from "DoublyBoundedRoundedContinuousComponentModel.h":
     cdef cppclass DoublyBoundedRoundedContinuousComponentModel:
        double score
     ...
     DoublyBoundedRoundedContinuousComponentModel *new_DoublyBoundedRoundedContinuousComponentModel "new DoublyBoundedRoundedContinuousComponentModel" (cpp_map[cpp_string, double] &in_hypers, int lower_bound, int upper_bound)
     DoublyBoundedRoundedContinuousComponentModel *new_DoublyBoundedRoundedContinuousComponentModel "new DoublyBoundedRoundedContinuousComponentModel" (cpp_map[cpp_string, double] &in_hypers, int lower_bound, int upper_bound, int COUNT, double SUM_X, double SUM_X_SQ)
     void del_DoublyBoundedRoundedContinuousComponentModel "delete" (DoublyBoundedRoundedContinuousComponentModel *ccm)

cdef class p_DoublyBoundedRoundedContinuousComponentModel:
    cdef DoublyBoundedRoundedContinuousComponentModel *thisptr
    cdef cpp_map[cpp_string, double] hypers
    def __cinit__(self, in_map, lower_bound, upper_bound, count=None, sum_x=None, sum_x_squared=None):
          set_string_double_map(self.hypers, in_map)
          if count is None:
              self.thisptr = new_DoublyBoundedRoundedContinuousComponentModel(self.hypers,
    ...
    def __dealloc__(self):
        del_DoublyBoundedRoundedContinuousComponentModel(self.thisptr)
